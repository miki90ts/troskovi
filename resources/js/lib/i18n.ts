...
const messages = {
    ...
    finance: {
        ...
        warranties: {
            ...
            expired: 'Istekle',
            totalWarranties: 'Ukupno garancija',
            managementTitle: 'Pregled garancija',
            managementDescription:
                'Pregledaj sve garancije sa datumom isteka i mogućnošću preuzimanja računa.',
            statusActive: 'Aktivna',
            statusExpiringSoon: 'Ističe uskoro',
            statusExpired: 'Istekla',
            daysRemaining: ':count dana preostalo',
            daysOverdue: 'Istekla pre :count dana',
            purchaseDate: 'Datum kupovine',
            expiresAt: 'Ističe',
            downloadReceipt: 'Preuzmi račun',
            viewReceipt: 'Prikaži račun',
            noReceipt: 'Nema slike računa',
            emptyTitle: 'Nema garancija',
            emptyDescription:
                'Kada dodaješ trošak, označi ga kao garancijski račun da bi se pojavio ovde.',
            filterAll: 'Sve',
            filterActive: 'Aktivne',
            filterExpiringSoon: 'Ističu uskoro',
    ...
    loyaltyCards: {
        head: 'Lojaliti kartice',
        badge: 'Lojaliti kartice',
        heroTitle: 'Tvoje lojaliti kartice',
        heroDescription:
            'Čuvaj sve lojaliti i članstvo kartice na jednom mestu. Kreiraj barkod koji možeš da pokažeš na kasi umesto fizičke kartice.',
        totalCards: 'Ukupno kartica',
        addCard: 'Dodaj karticu',
        managementTitle: 'Kartice',
        managementDescription: 'Pregledaj i upravljaj svojim karticama',
        searchPlaceholder: 'Pretraži kartice...',
        formBadge: 'Kartica',
        newTitle: 'Nova kartica',
        editTitle: 'Izmeni karticu',
        createDescription:
            'Dodaj novu lojaliti karticu. Unesi broj kartice i mi ćemo generisati barkod koji možeš da koristiš na prodajnim mestima.',
        editDescription: 'Izmeni podatke o lojaliti kartici.',
        cardName: 'Naziv kartice',
        cardNamePlaceholder: 'npr. Maxi klub kartica',
        cardNumber: 'Broj kartice',
        cardNumberPlaceholder: 'npr. 2860012345678',
        barcodePreview: 'Pregled barkoda',
        notes: 'Napomena',
        notesPlaceholder: 'Opciona napomena...',
        color: 'Boja kartice',
        chooseColor: 'Izaberi',
        fullscreen: 'Prikaži barkod',
        scanAtStore: 'Pokaži barkod na kasi za skeniranje',
        created: 'Kartica je kreirana',
        updated: 'Kartica je ažurirana',
        deleted: 'Kartica je obrisana',
        saveError: 'Čuvanje kartice nije uspelo',
        deleteError: 'Brisanje kartice nije uspelo',
        deleteTitle: 'Obriši karticu',
        deleteDescription:
            'Da li si siguran/na da želiš da obrišeš ovu karticu? Ova radnja se ne može poništiti.',
