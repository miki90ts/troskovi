    ...
    >
        ...
        >
            <div class="max-w-2xl space-y-4">
                ...
                >
                    {{ t('loyaltyCards.badge') }}
                </div>
                <div class="space-y-2">
                    <h1
                        class="text-3xl font-semibold tracking-tight text-foreground"
                    >
                        {{ t('loyaltyCards.heroTitle') }}
                    </h1>
                    <p class="max-w-xl text-sm leading-6 text-muted-foreground">
                        {{ t('loyaltyCards.heroDescription') }}
                    </p>
                </div>
                <div class="grid gap-3 sm:grid-cols-2">
                    ...
                    <div
                        class="flex items-center justify-center rounded-2xl border border-dashed border-border/60 bg-background/50 p-4 backdrop-blur"
                    >
                        <Button
